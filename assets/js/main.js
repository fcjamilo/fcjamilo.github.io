...
const textArray = ["An IT Enthusiast", "An IT Student", "A Web Developer"];
  ...
  function typeWriterEffect() {
    if (charIndex < textArray[index].length) {
      ...
      setTimeout(deleteEffect, 1000); // Delay before deleting
    }
  }
  ...
  function deleteEffect() {
    if (charIndex > 0) {
      ...
      setTimeout(typeWriterEffect, 200); // Start typing the next word
    }

  }
  // Start the typewriter effect
  setTimeout(typeWriterEffect, 500); // Delay before starting
